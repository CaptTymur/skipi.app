...
ok(html.includes("component_version: '0.4.186'"), 'build-metadata input carries component version 0.4.186');
...
ok(cargo.includes('version = "0.4.186"'), 'Cargo package version is 0.4.186');
ok(lock.includes('name = "skipi"\nversion = "0.4.186"'), 'Cargo lock root package version is 0.4.186');
ok(tauri.version === '0.4.186', 'Tauri component version is 0.4.186');
