...
ok(html.includes("component_version: '0.4.189'"), 'build-metadata input carries component version 0.4.189');
...
ok(cargo.includes('version = "0.4.189"'), 'Cargo package version is 0.4.189');
ok(lock.includes('name = "skipi"\nversion = "0.4.189"'), 'Cargo lock root package version is 0.4.189');
ok(tauri.version === '0.4.189', 'Tauri component version is 0.4.189');
