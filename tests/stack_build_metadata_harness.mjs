...
ok(html.includes("component_version: '0.4.190'"), 'build-metadata input carries component version 0.4.190');
...
ok(cargo.includes('version = "0.4.190"'), 'Cargo package version is 0.4.190');
ok(lock.includes('name = "skipi"\nversion = "0.4.190"'), 'Cargo lock root package version is 0.4.190');
ok(tauri.version === '0.4.190', 'Tauri component version is 0.4.190');
