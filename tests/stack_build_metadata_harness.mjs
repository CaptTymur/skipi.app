...
ok(html.includes("component_version: '0.4.187'"), 'build-metadata input carries component version 0.4.187');
...
ok(cargo.includes('version = "0.4.187"'), 'Cargo package version is 0.4.187');
ok(lock.includes('name = "skipi"\nversion = "0.4.187"'), 'Cargo lock root package version is 0.4.187');
ok(tauri.version === '0.4.187', 'Tauri component version is 0.4.187');
