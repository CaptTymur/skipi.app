...
ok(html.includes("component_version: '0.4.188'"), 'build-metadata input carries component version 0.4.188');
...
ok(cargo.includes('version = "0.4.188"'), 'Cargo package version is 0.4.188');
ok(lock.includes('name = "skipi"\nversion = "0.4.188"'), 'Cargo lock root package version is 0.4.188');
ok(tauri.version === '0.4.188', 'Tauri component version is 0.4.188');
