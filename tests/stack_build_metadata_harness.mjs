...
ok(html.includes("component_version: '0.4.191'"), 'build-metadata input carries component version 0.4.191');
...
ok(cargo.includes('version = "0.4.191"'), 'Cargo package version is 0.4.191');
ok(lock.includes('name = "skipi"\nversion = "0.4.191"'), 'Cargo lock root package version is 0.4.191');
ok(tauri.version === '0.4.191', 'Tauri component version is 0.4.191');
